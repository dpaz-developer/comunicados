...
CREATE TABLE notices (
	...
	subtitle varchar(400) charset utf8,
	urlImageMain varchar(300),
	urlImageDetail varchar(300),
   urlDocumentAtach varchar(300),
...
BEGIN
	...
	IF (v_seccionId = 0) THEN
		BEGIN
			SET @s_query =  CONCAT('SELECT id, title, body, summary, sectionId, dateRegistration, status, userLoadId, urlImageMain, urlImageDetail, subtitle, urlDocumentAtach 
	 FROM notices
...
BEGIN
	SELECT id, title, body, summary, sectionId, dateRegistration, dateUpdate, status, userLoadId, urlImageMain, urlImageDetail, subtitle, urlDocumentAtach
	FROM notices
	WHERE id = v_id;
END//
DELIMITER ;
...
CALL sp_set_nota ( '¡Qué no te dé frío!', ' ','Utiliza tu cupón de staff y compra tu chamarra en Martí.mx ',3, 'active',1, 'images/noticias/frio.jpg', 'images/noticias/frio.jpg', '', '');
CALL sp_set_nota ( 'Feliz día del nutriólogo ', ' ','Sport City felicita a todos nuestros  nutriolog@s ',3, 'active',1, 'images/noticias/dia_del_nutrilogo.jpg', 'images/noticias/dia_del_nutrilogo.jpg', '', '');
CALL sp_set_nota ( 'SCUcharlas 27 de enero ', ' ','¡Sport City University   desea que sigas aprendiendo y  te invita  a  SCU Charlas ¡',4, 'active',1, 'images/noticias/SCUcharla_27_de_enero.jpg', 'images/noticias/SCUcharla_27_de_enero.jpg', '', '');
...
CALL sp_set_nota ( 'Lanzamiento nueva imagen ED', ' ','Compartimos contigo nuestra nueva imagen ¡Conócela Aquí!',3, 'active',1, 'images/noticias/comunicado-12.jpg', 'images/noticias/comunicado-12.jpg', '', '');

CALL sp_set_nota ( 'Código de vestimenta ', ' ','Atención Staff:
...
CALL sp_set_nota ( 'Entrega de premios foáneos ', ' ','La entrega de premios foraneos se estará realizando del 14 al 31 de enero m                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ',3, 'active',1, 'images/noticias/.jpg', 'images/noticias/.jpg', '', '');


-- le colocamos un remate a la noticia 1

UPDATE notices SET subtitle='Nuevas responsabilidades en sport city' WHERE id = 1;
